      ...
      <div className="flex h-screen w-full overflow-hidden">{/* Fixed viewport height */}
        ...
        <div className="flex-1 flex flex-col h-screen">{/* Fixed layout container */}
          ...
          <footer className="border-t p-4 text-center text-xs text-muted-foreground bg-background">
            <p>Built by Ossian Design Lab • <a href="mailto:support@iconstack.io" className="hover:text-primary">Support</a> • <a href="https://buymeacoffee.com/finalcommit" target="_blank" rel="noopener noreferrer" className="hover:text-primary">Buy me a coffee</a></p>
          </footer>
        </div>
