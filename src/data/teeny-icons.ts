...
const categorizeIcon = (key: string): string => {
  ...
  if (lowerKey.includes('settings') || lowerKey.includes('config') || lowerKey.includes('gear') || lowerKey.includes('system') || lowerKey.includes('adjust')) {
    return 'system';
  }
  ...
  if (lowerKey.includes('shopping') || lowerKey.includes('cart') || lowerKey.includes('commerce') || lowerKey.includes('money')) {
    return 'commerce';
  }
  ...
  if (lowerKey.includes('text') || lowerKey.includes('align') || lowerKey.includes('format') || lowerKey.includes('font')) {
    return 'text';
  }
...
export const teenyIcons: IconItem[] = Object.entries(iconMap)
