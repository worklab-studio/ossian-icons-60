...
export const SYNONYM_MAP: Record<string, string[]> = {
  ...
  // UI Actions
  'close': ['x', 'cross', 'cancel', 'dismiss'],
  'cancel': ['close', 'abort', 'stop', 'x'],
  'send': ['share', 'submit', 'dispatch'],
  'logout': ['signout', 'exit', 'leave', 'logoff'],
  'login': ['signin', 'enter', 'authenticate', 'logon'],
  'signup': ['register', 'join', 'enroll'],
  'refresh': ['reload', 'sync', 'update', 'rotate'],
  'expand': ['maximize', 'fullscreen', 'enlarge', 'grow'],
  'collapse': ['minimize', 'shrink', 'reduce', 'compress'],
  'open': ['launch', 'start', 'begin'],
  'print': ['printer', 'document', 'paper'],
  'undo': ['back', 'revert', 'reverse'],
  'redo': ['forward', 'repeat'],
  
  // Layout & UI
  'grid': ['table', 'layout', 'matrix'],
  'list': ['rows', 'items', 'lines'],
  'sidebar': ['panel', 'drawer', 'menu'],
  'modal': ['dialog', 'popup', 'overlay'],
  'tab': ['panel', 'section', 'page'],
  
  // Misc
  'link': ['chain', 'url', 'connect', 'anchor'],
  'globe': ['world', 'earth', 'internet', 'web'],
  'wifi': ['wireless', 'signal', 'internet', 'network'],
  'battery': ['power', 'charge', 'energy'],
  'flag': ['report', 'mark', 'banner'],
  'clip': ['paperclip', 'attach', 'attachment'],
  'attach': ['paperclip', 'clip', 'pin'],
  'bold': ['strong', 'text', 'font'],
  'italic': ['emphasis', 'text', 'font'],
  'code': ['programming', 'develop', 'terminal', 'bracket'],
  'terminal': ['console', 'command', 'shell', 'code'],
  'database': ['storage', 'data', 'server', 'db'],
  'server': ['host', 'computer', 'machine', 'database'],
  ...
  'headphones': ['earphones', 'audio', 'music', 'headset'],
  ...
  'slider': ['range', 'adjust', 'control'],
  'spinner': ['loading', 'progress', 'wait'],
  'loading': ['spinner', 'progress', 'wait', 'buffer'],
  'progress': ['loading', 'bar', 'status'],
  'chart': ['graph', 'analytics', 'statistics', 'data'],
  'graph': ['chart', 'analytics', 'statistics', 'data'],
  'analytics': ['chart', 'graph', 'statistics', 'data'],
  'dashboard': ['home', 'overview', 'panel', 'admin'],
  'rubbish': ['trash', 'delete', 'garbage', 'bin', 'waste'],
